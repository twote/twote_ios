...
+ (id) sharedInstance
{
    static TWActivityIndicator *_sharedInstance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _sharedInstance = [[TWActivityIndicator alloc] initWithFrame:CGRectMake([[UIScreen mainScreen] bounds].size.width/2, [[UIScreen mainScreen] bounds].size.height/2, 50, 50)];
    });
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        colorsArray = [NSMutableArray arrayWithObjects:
                       [UIColor colorWithRed:0.800 green:0.800 blue:0.200 alpha:1.000],
                       [UIColor colorWithRed:0.600 green:0.600 blue:0.200 alpha:1.000],
                       [UIColor colorWithRed:0.400 green:0.400 blue:0.000 alpha:1.000],
